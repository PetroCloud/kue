...
/**
 * Return job ids with the given `type`, and given 'state', and callback `fn(err, ids)`.
 *
 * @param {String} state
...
Queue.prototype.type = function (type, state, fn) {
    this.client.zrange(this.client.getKey('jobs:' + type + ":" + state), 0, -1, fn);
    return this;
};
